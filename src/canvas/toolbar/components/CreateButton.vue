			...
			<div class="MatcCreateBtnCntr MatcPadding">
				<div class="container-fluid">
					<div class="row" v-show="tab === 'widgets'">
						<div class="col-md-10 MatcCreateBtnElementList MatcCreateBtnRight"
							data-dojo-attach-point="rightCntr">
							<div class="MatcHint">Loading Widgets...</div>
						</div>
						<div class="col-md-2 MatcCreateBtnLeft">
							<div class="form-group has-feedback">
								<input type="search" class=" MatcCreateSearch MatcIgnoreOnKeyPress form-control"
									placeholder="Search" data-dojo-attach-point="searchBox" />
								<span class="mdi mdi-magnify  form-control-feedback MatcCreateSearchBtn "
									aria-hidden="true" data-dojo-attach-point="searchRemoveBtn"></span>
							</div>
					...
					<div class="row" v-show="tab === 'import'">
						<div @mousedown.stop="" class="col-md-12 MatcCreateBtnElementList MatcCreateBtnRight">
							...
							<div class="MatcButtonBar">
								<a class="MatcButton" @click="onSaveImports">Save</a> <a class="MatcLinkButton"
									@click="showWidgets()">Back</a>
							</div>
						</div>
...
import { setGridWidgets } from 'src/newCustomData.js'
		...
		renderElements(elements, category, isTemplate, append) {
			...
			if (elements.length === 0) {
				...
				for (let i = 0; i < elements.length; i++) {
					...
					if (child.id == 'Horizontal' || child.id == 'Vertical') {
						setGridWidgets(child);
					}
